    ...
    <div className="w-full px-36 py-8 bg-blue-950">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {experienceData.map((exp, index) => (
          <div
            key={index}
            className="bg-white/20 border-2 border-white rounded shadow-md p-6 hover:scale-[1.02] transition-transform duration-300"
          >
              ...
              .map((timeline, i) => (
                <div key={i} className="mb-4">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-lg text-white font-semibold border-l-4 border-red-500 pl-2 mb-2">
                      {timeline.job_role}
                    </h3>
                    <div className="text-sm text-gray-200 flex items-center gap-2 mb-2">
                      <FaCalendarAlt />
